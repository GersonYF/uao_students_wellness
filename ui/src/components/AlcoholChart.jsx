...
const AlcoholChart = ({ data }) => {
  const ref = useRef();

  const alcoholData = data.filter(d => d.Category === 'Alcohol consumption classification')
  ...
  return (
    <Card>
      <Card.Body>
        <Card.Title>Clasificación de Consumo de alcohol</Card.Title>
        <div ref={ref} />
      </Card.Body>
    </Card>
  );
